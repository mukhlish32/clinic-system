<div class="container-fluid">
    ...
    <div class="card shadow-sm">
        <div class="card-header card-primary d-flex justify-content-between align-items-center">
            <h5 class="mb-0 fw-bold text-white">List Tindakan</h5>
            <a href="<?php echo Yii::app()->createUrl('master/tindakan/create'); ?>" class="btn btn-sm btn-success btn-label">
        ...
        <div class="card-body">
            ...
            <div class="container-fluid">
                ...
                <div class="border p-3 mb-4 rounded bg-info-subtle">
                    <div class="row">
                        ...
                        <!-- <div class="col-md-3 mb-2">
                            <label for="filter-harga" class="form-label">Harga</label>
                            <input type="text" id="filter-harga" class="form-control form-control-sm filter-input" placeholder="Filter Harga">
                        </div>
                        <div class="col-md-3 mb-2">
            ...
            <div class="table-responsive" style="max-width: 100%; overflow-x: auto;">
                <table id="tindakan-table" class="table table-bordered nowrap align-middle" style="width: 100%; table-layout: auto;">
...
<?php
Yii::app()->clientScript->registerScript('tindakan-table-script', "
$(document).ready(function() {
    var table = $('#tindakan-table').DataTable({
        ...
        ajax: {
            url: '" . Yii::app()->createUrl('master/tindakan/index') . "',
            type: 'GET',
            data: function(d) {
                d.ajax = 1;
                d.kode = $('#filter-kode').val();
                d.nama = $('#filter-nama').val();
                d.harga = $('#filter-harga').val();
