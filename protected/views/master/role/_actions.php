<div class="action-buttons d-flex flex-column gap-2">
    <div class="d-flex gap-2">
        <?php if ($this->checkAccess($location, 'permission')): ?>
            <a href="<?php echo Yii::app()->createUrl($location . '/permissions', ['id' => $model->id]); ?>" class="btn btn-sm btn-success btn-label w-md">
